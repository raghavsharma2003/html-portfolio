...
try{
 ...
 const waitFor=async(label,predicate)=>{const end=Date.now()+10000;while(!predicate()&&Date.now()<end)await new Promise(r=>setTimeout(r,10));assert(predicate(),`${label}: bounded HTTP barrier; state=${httpState()}`);};
