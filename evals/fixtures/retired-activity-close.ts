// Frozen client fixture from 16fae19:src/components/activityClose.ts.
// Imports alone point to current shared engines. This is not a shipped UI caller.
...
import type { GameSession } from "../../src/state/game";
import { activityOf } from "../../src/state/game";
import { LABEL } from "../../src/engine/activity";
import { latestSkill, logFinishedActivity, withActivityRecord, type ActivityRecord } from "../../src/engine/memory";
import { nextSkill } from "../../src/engine/chess";
