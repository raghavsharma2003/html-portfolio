...
const model = await import(pathToFileURL(join(ROOT, "src/creatorStudio/studioTestMode.ts")));
...
const studio = readFileSync(join(ROOT, "src/creatorStudio/StudioApp.tsx"), "utf8");
const enrollment = readFileSync(join(ROOT, "src/creatorStudio/EnrollmentWorkspace.tsx"), "utf8");
const contextLocker = readFileSync(join(ROOT, "src/creatorStudio/ContextLockerPanel.tsx"), "utf8");
const videoEnroll = readFileSync(join(ROOT, "src/creatorStudio/VideoEnrollPanel.tsx"), "utf8");
const channelWatch = readFileSync(join(ROOT, "src/creatorStudio/IngestChannelStudio.tsx"), "utf8");
const voiceExperiment = readFileSync(join(ROOT, "src/creatorStudio/VoiceExperimentPanel.tsx"), "utf8");
const voiceExperimentContract = readFileSync(join(ROOT, "src/creatorStudio/voiceExperiment.ts"), "utf8");
// WS-R71: VoiceExperimentPanel.tsx's own literal strings moved into
// src/creatorStudio/copy.ts (`t.voiceExperimentPanel`); assertions below that check
