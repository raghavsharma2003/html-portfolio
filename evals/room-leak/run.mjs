...
// ═════════════════════════════════════════════════════════════════════════
// LAYER 7 (WS-R66, migration 115) — THE CREATOR'S OWN PUBLIC-PAGE SHOWCASE.
...
// ═════════════════════════════════════════════════════════════════════════
console.log("\n── layer 7: showcase (the creator's own writer cannot surface a follower's words) ──");
...
// match `leakedTokens` (this file's own scanner) would actually catch.
{
  ...
  const db = async (sql, params = []) => {
    ...
    throw new Error(`layer 7 fake db: unmatched SQL: ${sql}`);
  };
