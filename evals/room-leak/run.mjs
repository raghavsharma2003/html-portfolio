...
// ═════════════════════════════════════════════════════════════════════════
// LAYER 7 — WS-R68. THE FULL WORLD. Five Rooms, two Suites, 100 followers
...
// before this suite).
// ═════════════════════════════════════════════════════════════════════════
console.log(`\n── layer 7: the full world (WS-R68) — seed ${DEFAULT_SEED} ──`);
{
  const t0 = Date.now();
...
// ── LAYER 7, NEGATIVE CONTROL A (law 4): a struck WHERE in a fixture copy of
...
// ── LAYER 7, NEGATIVE CONTROL B (law 4): a writer added to a temp copy of a
...
// ── LAYER 7, STATIC: the generalized reach layer over the real api/ tree —
