...
let readFail = false, holdRead = false, uncertainReply = false, holdReply = false, releaseReply = null, uncertainOpen = false;
...
try {
  ...
  for (const width of old ? [390] : [390, 1440]) {
    sessions.clear(); requests.length = 0; readFail = false; create(SESSION, RID, "synthetic-owner-a", true);
