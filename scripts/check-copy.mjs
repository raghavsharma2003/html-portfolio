 ...
 */
// WS-AE, same window: `StudioApp.tsx`'s purge landed, this gate's own
// expiry rule fired ("a waived file is now clean; delete its entry"), and the
// entry is deleted. That is the waiver working exactly as its comment above
// says it must, on its first use.
