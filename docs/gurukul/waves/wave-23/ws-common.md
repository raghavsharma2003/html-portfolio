# Common brief for every Vyakti workstream, wave twenty-three (2026-09-13)
...
safety with a schema-mirror gate, and the merge repairs). The main loop (Fable) merges your branch,
...
2. context/STATE.md: the FIRST block ("WAVE TWENTY-TWO MERGED"), then the
...
- Worktree: `git log --oneline -1` must show the wave-twenty-three base named in
