...
alter table vy_room_arrival add constraint vy_room_arrival_via_check
  -- Reconciled at the merge (2026-09-05): WS-R85's migration 122 widened this
  -- same constraint to ten values in the same wave, so this one names the
  -- union, never a subset that would refuse the share kit's own channels.
