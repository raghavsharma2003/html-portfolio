...
export const PRIVATE_REHEARSAL_LIMITS = Object.freeze({ question: 2000, evidence: 8000, core: 8000, system: 30000 });
...
export function compilePrivateExpertRehearsal(input: PrivateRehearsalInput): CompiledPrompt & {
  profile: typeof PRIVATE_REHEARSAL_PROFILE; question: string;
  ...
  return { profile: PRIVATE_REHEARSAL_PROFILE, core, tail, system, question,
