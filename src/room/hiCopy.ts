...
export const HI: RoomRestCopy = {
  ...
  referral: {
    ...
    note: "यह लिंक शेयर करें। अगर कोई दोस्त इससे जुड़ता है, तो सिर्फ \"एक दोस्त आया\" दिखता है - कभी यह नहीं कि कौन।",
    copy: "लिंक कॉपी करें",
    copied: "कॉपी हो गया",
  },
  ...
  // WS-R154 ("RelationOS in the Room"). EN's own copy.ts entry has the full
  // reasoning; same keys, same enum values, plain functional Hindi.
  relState: {
    title: "आप दोनों की स्थिति",
    none: "अभी इसे आप दोनों के बारे में कोई अंदाज़ा नहीं है - बात करते रहें, यह बन जाएगा।",
    stage: {
      new: "अभी आपको जानना शुरू कर रहा है।",
      warming: "धीरे-धीरे अपनापन बढ़ रहा है।",
      settled: "एक सहज लय में बस गया है।",
      close: "करीबी।",
      deep: "गहरा, बिना जल्दबाज़ी वाला भरोसा।",
    },
    honorific: {
      tu: "यह आपसे सबसे अपने अंदाज़ में बात करता है (तू)।",
      tum: "यह आपसे रोज़मर्रा के अंदाज़ में बात करता है (तुम)।",
      aap: "यह आपसे थोड़े औपचारिक अंदाज़ में बात करता है (आप)।",
    },
    ruptureOpen: "एक बात अभी भी इसके मन में अटकी हुई है।",
    ruptureSettled: (ageLabel: string) => `${ageLabel} पहले की एक बात अब सुलझ चुकी है - यह अब उसे लेकर आपसे नाराज़ नहीं है, पर भूला भी नहीं है।`,
    resetTitle: "नई शुरुआत करें",
    resetNote: "इससे ऊपर वाली बात सुलझ जाएगी। यह उस बात को मिटाता नहीं, सिर्फ यह कि अभी वह आपसे नाराज़गी जैसा महसूस न हो।",
    resetAction: "नई शुरुआत करें",
    resetDone: "हो गया - अब यह उसे लेकर आपसे नाराज़ नहीं है।",
    resetNothingOpen: "अभी सुलझाने के लिए कुछ भी खुला नहीं है।",
    resetError: "यह नहीं हो सका। फिर कोशिश करें।",
  },
};
