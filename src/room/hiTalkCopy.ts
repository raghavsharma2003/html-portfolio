...
export const HI_TALK: RoomTalkCopy = {
  ...
  unavailable: {
    ...
    body: "लिंक पुराना हो सकता है, या इस व्यक्ति ने इसे रोक दिया हो। और कुछ गलत नहीं हुआ।",
  },
  ...
  flag: {
    ...
    done: "फ़्लैग हो गया। समीक्षा के लिए भेज दिया गया है।",
  ...
  pay: {
    ...
    priceNotSet: "इस रूम के लिए अभी कीमत तय नहीं की गई है।",
  ...
  account: {
    ...
    rememberedTitle: "याद रखी बातें",
    rememberedNote: "किसी सहेजी बात को अपने शब्दों में बदलें, या सिर्फ वही बात हटाएं।",
    rememberedEmpty: "अभी यहां कुछ सहेजा नहीं गया है।",
    rememberedLoading: "सहेजी बातें लोड हो रही हैं",
    rememberedEdit: "बदलें",
    rememberedForget: "भूलें",
    rememberedReplacementLabel: "इसके बदले इसे क्या याद रखना चाहिए?",
    ...
    subscriptionNoCancel: "यहां से रद्द करना अभी उपलब्ध नहीं है। रद्द करने के लिए इस व्यक्ति से संपर्क करें।",
    subscriptionStates: {
      ...
      halted: "आपका पिछला भुगतान नहीं हो पाया। अपना UPI ऐप जांचें, या अगर यह बार-बार हो रहा है तो इस व्यक्ति से संपर्क करें।",
  ...
  checkins: {
    ...
    empty: "यहां अभी तक कोई चेक-इन सेट नहीं किया गया है।",
