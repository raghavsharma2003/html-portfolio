...
const EN = {
  ...
  account: {
    ...
    rememberedTitle: "Remembered things",
    rememberedNote: "Change a saved detail in your own words, or remove just that detail.",
    rememberedEmpty: "Nothing has been saved here yet.",
    rememberedLoading: "Loading saved details",
    rememberedEdit: "Edit",
    rememberedForget: "Forget",
    rememberedReplacementLabel: "What should it remember instead?",
