...
export default function CloneExperience(props: CloneExperienceProps) {
  ...
  const feedCopy = rehearsalQuery.get("lang") === "hi"
    ? { test: "इस सामग्री से पूछें", back: "निजी सवाल पर लौटें" }
    : { test: "Test this source", back: "Back to private test" };
  ...
  const textWorkspaceOpen = knowledgeOpen || textShareOpen;
