  ...
  return (
    <div className="cvj-shell" data-stage={stage}>
      ...
      <main className={`cvj-stage cvj-stage--${stage}`} aria-label="Clone verification">
        ...
        {stage === "liveness" ? <Suspense fallback={<DeferredVerificationStage stage={stage} />}><LivenessCapture consentActive={sourceConsentActive && replica.age_verified} challenge={challenge} loading={livenessLoading} onIssue={onIssueChallenge} onStartFace={onStartFaceSession} onPollFace={onPollFaceSession} onCancel={onCancelChallenge} onCreateUpload={onCreateLivenessUpload} onRetryUpload={onRetryUpload} onFinalize={onFinalizeLiveness} /></Suspense> : null}
