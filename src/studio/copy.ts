...
const EN_CLONE_EXPERIENCE_SHELL: CloneExperienceShellCopy = {
  capture: {
    ...
    readyHeading: "Listen to your recording.",
    sayHeading: "Start with your voice.",
    readyBody: "Choose the language, then continue.",
    sayBody: "Share a thought in your own words.",
    ...
    signalUsable: "Recording level looks good.",
    initialHint: "Tap Begin. Tap Finish when you are done.",
    keepSpeakingTemplate: "Keep speaking for {n} more seconds.",
    reviewHint: "Uploaded only when you continue.",
  ...
  agreement: {
    ...
    body: "Choose what your AI can use. You can change or erase it later.",
  ...
  rooms: {
    voice: {
      ...
      conversation: "Talk",
      voiceSample: "Voice",
      privateDraftTest: "Draft",
      listeningTest: "Listen",
...
const EN_FIRST_FIVE_MINUTES: FirstFiveMinutesCopy = {
  ...
  signInTitle: "Sign in",
  firstSourceTitle: "Feed it",
  firstSourceHint: "Add a recording, a file or a few words.",
  meetTitle: "Meet it",
  meetHint: "Preparing your AI. You can add more while you wait.",
  stepDoneLabel: "Done",
};
