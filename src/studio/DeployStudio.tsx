...
const DEPLOY_COPY: Record<StudioLocale, DeployCopy> = {
  en: {
    ...
    intro: "Take your AI everywhere your people already are.",
    ...
    publishLabel: "Publish who you are first.",
    publishBody: "Your AI needs a published, consented sheet before a Room can open to anyone.",
    publishAction: "Review it",
  ...
  hi: {
    ...
    intro: "अपने AI को वहाँ ले जाएँ जहाँ आपके लोग पहले से मौजूद हैं।",
    ...
    publishLabel: "पहले बताएं कि आप कौन हैं।",
    publishBody: "Room किसी के लिए खुलने से पहले आपके AI की एक प्रकाशित, सहमति-प्राप्त शीट ज़रूरी है।",
    publishAction: "इसे देखें",
