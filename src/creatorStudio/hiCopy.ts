...
export const HI: StudioRestCopy = {
  ...
  roomStudio: {
    ...
    setupTitle: "अपना Room बनाएं",
    setupIntro: "हर व्यक्ति को अपने AI से बात करने की निजी जगह दें। सब ठीक लगे तो इसे प्रकाशित करें और लिंक साझा करें।",
    ...
    relStageTitle: "आपके फॉलोअर कितने करीब हैं",
    relStageIntro:
      "हर फॉलोअर के आपकी AI के साथ रिश्ते की स्थिति का एक मोटा अंदाज़ा, सिर्फ़ गिनती में - कभी कोई नाम नहीं, " +
      "कभी कोई संदेश नहीं, और कभी पांच से कम लोगों की गिनती नहीं।",
    relStageNone: "अभी इतने फॉलोअर नहीं हैं कि एक भी ऐसी गिनती दी जा सके जो किसी की पहचान न बताए।",
    relStageWords: {
      new: "अभी इसे जानना शुरू कर रहे हैं",
      warming: "धीरे-धीरे अपनापन बढ़ रहा है",
      settled: "एक सहज लय में बस गए हैं",
      close: "करीबी",
      deep: "गहरा, बिना जल्दबाज़ी वाला भरोसा",
    },
    relStageFloorNote: "पांच से कम फॉलोअर वाले किसी भी समूह को जानबूझकर छोड़ दिया जाता है।",
  },
  ...
  runtimeGate: {
    setupIntro: "अपने AI से निजी बातचीत शुरू करने के लिए नीचे दी गई जांच पूरी करें।",
    versionDetails: "वर्शन की जानकारी",
    labels: {
  ...
  candidateEvaluationLab: {
    ...
    eyebrow: "अंधी तुलना",
    title: "कौन सा जवाब आपके जैसा है?",
    intro: "लिखे हुए जवाबों की तुलना करें। आपकी पसंद समीक्षा के लिए सहेजी जाएगी।",
    sealAriaLabel: "समीक्षा की गोपनीयता स्थिति",
    blindedLabel: "छिपा हुआ",
    mappingNote: "नाम छिपे रहेंगे",
    loadingAriaLabel: "अंधी समीक्षा लोड हो रही है",
    comparisonUnavailable: "तुलना उपलब्ध नहीं है",
    tryAgain: "फिर कोशिश करें",
    emptyHeadline: "अभी तुलना तैयार नहीं है।",
    ...
    completeNote: "{n} तुलनाएं सहेजी गईं। आपका मौजूदा AI नहीं बदला है।",
  ...
  personModelStudio: {
    ...
    citedExtractionTitle: "अपने समीक्षा किए गए सबूत को अपने नियंत्रण वाले दावों में बदलें",
    citedExtractionIntro:
      "स्वीकृत लक्षित-स्पीकर ट्रांसक्रिप्ट हिस्से और आपके अपने लिखे हुए दस्तावेज़ों का प्रमाणित टेक्स्ट योग्य हैं। कच्चा सोर्स टेक्स्ट सिर्फ़ सर्वर पर रहता " +
    ...
    noClaimsHeadline: "अभी समीक्षा किए गए दावे नहीं हैं।",
  ...
  teacherSheetStudio: {
    ...
    serviceUnavailableNotice: "सहेजा हुआ ड्राफ्ट लोड नहीं हुआ। आपके मौजूदा बदलाव यहीं हैं।",
    ...
    draftDetailsLabel: "ड्राफ्ट का विवरण (सिर्फ़ पढ़ने के लिए)",
    ...
    loadKeptNewerEdits: "आपके नए बदलाव रखे गए हैं। सहेजा हुआ ड्राफ्ट लोड नहीं किया गया।",
    savedEarlierEdits: "पहले के बदलाव सहेजे गए। नए बदलाव अभी सहेजने हैं।",
    saveUnconfirmed: "सहेजने की पुष्टि नहीं हुई। आपके बदलाव यहीं हैं। जाँचने के लिए सहेजा हुआ ड्राफ्ट लोड करें।",
    loadingSavedDraft: "सहेजा हुआ ड्राफ्ट लोड हो रहा है...",
  ...
  studioApp: {
    ...
    voiceUnlockNotice: {
      scopeLabel: "साझा करने से पहले",
      bodyMissingBoth: "इस आवाज़ को किसी और से बात करने देने से पहले, अपनी पहचान सत्यापित करें और लाइव चैलेंज पूरा करके पुष्टि करें कि यह आपकी है।",
      bodyMissingLiveness: "इस आवाज़ को किसी और से बात करने देने से पहले, लाइव चैलेंज पूरा करके पुष्टि करें कि यह आपकी है।",
      bodyMissingIdentity: "इस आवाज़ को किसी और से बात करने देने से पहले, अपनी पहचान सत्यापित करके पुष्टि करें कि यह आपकी है।",
