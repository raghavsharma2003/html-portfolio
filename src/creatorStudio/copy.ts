...
const EN: StudioCopy = {
  ...
  candidateEvaluationLab: {
    ...
    title: "Which reply is more like you?",
    intro: "Compare the written replies. Your choices are saved for review.",
    sealAriaLabel: "Evaluation blinding status",
    blindedLabel: "BLINDED",
    mappingNote: "Names stay hidden",
    loadingAriaLabel: "Loading blind evaluation",
    comparisonUnavailable: "Comparison unavailable",
    tryAgain: "Try again",
    emptyHeadline: "No comparison is ready yet.",
    ...
    completeNote: "{n} comparisons saved. Your current AI has not changed.",
