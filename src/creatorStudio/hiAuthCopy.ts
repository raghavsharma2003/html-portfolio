...
export const HI_AUTH: StudioAuthCopy = {
  personalAuth: {
    ...
    legalNotice: "साइन इन करने के बाद आपकी सामग्री के इस्तेमाल का सहमति पत्र दिखेगा। आपकी आवाज़ में कोई AI ऑडियो बनाने से पहले पहचान की जांच और AI को आपकी आवाज़ इस्तेमाल करने की अनुमति के चरण दिखाए जाएंगे।",
