...
import { voiceSampleUrl } from "../studio/workspaceNavigation";
  ...
  return (
    <section className="voice-preview-lab" aria-labelledby="voice-preview-title">
      <div className="voice-preview-heading">
        ...
        <button className="review-refresh" type="button" disabled={loading || pairBusy} onClick={() => void load()}>{loading ? c.checking : c.refreshDraft}</button>
      </div>

      <div className="voice-preview-compose">
        <a className="button primary-button" href={voiceSampleUrl(replicaId, window.location.search)}>{c.generatePreview}</a>
      ...
      <div className="voice-preference-lab">
        <div className="voice-preference-intro">
          ...
          <button className="review-refresh" type="button" disabled={!draft || pairBusy} onClick={() => void generateBlindPair()}>{pairBusy ? c.renderingAB : pair ? c.newBlindPair : c.startBlindAB}</button>
        </div>
        {pair ? (
