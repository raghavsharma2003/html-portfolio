...
async function handler(req, res) {
  ...
  try {
    ...
    // injects a fake.
    const summary = await withSweepRun(q, "checkins", () => sweep({ db: q, limit, loadAgent: loadTeacherAgent, fetch: globalThis.fetch }, Date.now()));
...
export default withDoor(q, "checkins-sweep.js", handler);
